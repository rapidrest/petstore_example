...
NOTE: This is a fork of the main project that reaplces the RapidREST HTTP engine with Express.js. It is intended
...
```bash
helm install --create-namespace --namespace petstore petstore oci://ghcr.io/rapidrest/charts/petstore --version 1.1.1-express
```
